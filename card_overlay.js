(function () {
    ...
    function measureEpisodeLabelPosition(card) {
        ...
        if (typeLabel) {
            ...
            props.push(['line-height', '1.1']);      // Висота рядка
