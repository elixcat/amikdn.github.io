(function() {
  ...
  // Запускаємо перевірку кожні 500мс, поки не з'явиться контейнер
  var interval = setInterval(function() {
    if ($('#app > div.head > div > div.head__actions').length > 0) {
      addButtons();
    }
  }, 500);

  // Зупиняємо перевірку через 10 секунд, щоб не навантажувати систему
